...
#if defined(is_ipad)
    #define remoteVideoWidth 480
    #define remoteVideoHeight 512
    #define remoteVideoMargin 144
    #define screenWidth 768
#else
    #define remoteVideoWidth 227
    #define remoteVideoHeight 261
    #define remoteVideoMargin 46
...
- (void) receiveNotification:(NSNotification *)notification
{
    ...
    if ([[notification name] isEqualToString:@"onUserJoined"])
    {
        ...
        [self.scrollView setContentOffset:CGPointMake(screenWidth * ([_alUserIdToVideoView count] - 1), 0) animated:YES];
...
{
    CGRect frame;
    frame.origin.x = (screenWidth * idx) + remoteVideoMargin;
    frame.origin.y = 0;
    frame.size.width = remoteVideoWidth;
    frame.size.height = remoteVideoHeight;
    return frame;
}
